<?php if (isset($item)) { 
	return current_context()->response->setBody('Redirect')->getHeaders()->redirect(url(['definitions', 'setting'], 'detail', $item->_id)); } ?>
				...
				<form method="POST" action="">
					<div class="row l9">
						...
						<div class="span l8">
							...
							<div class="spacer minuscule"></div>
							<input type="text" name="title" class="frm-ctrl" id="input-url" value="" placeholder="Title...">
							<div class="spacer small"></div>
							<textarea name="description" class="frm-ctrl" value="" placeholder="Description..."></textarea>
							<div class="spacer small"></div>
							<select name="type" class="frm-ctrl" value="">
