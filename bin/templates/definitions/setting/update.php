...
<div class="row l1">
	<div class="span l1">
		...
		<p>
			Setting changes are applied immediately. For management reasons, you cannot
			rename the programmer-identifier of a setting, please refer to computed
			settings for this. You also cannot change the type of a setting after it 
			was created.
		</p>
				...
				<form method="POST" action="">
					<div class="row l9">
						...
						<div class="span l8">
							...
							<div class="spacer minuscule"></div>
							<input type="text" name="caption" class="frm-ctrl" id="input-url" value="<?= _q(_e($item->caption)) ?>" placeholder="Caption...">
							<div class="spacer small"></div>
